...
class PPO(Algorithm):
    ...
    def __init__(self, state_shape, action_shape, device, seed, gamma=0.995,
        ...
        self.actor.load_state_dict(torch.load("actor_1.pth"))
        ...
        self.critic.load_state_dict(torch.load("critic_1.pth"))
    ...
    def update_critic(self, states, targets):
        ...
        if self.learning_steps_ppo % self.epoch_ppo == 0:
            print('loss/critic', loss_critic.item(), self.learning_steps)
            '''writer.add_scalar(
    ...
    def update_actor(self, states, actions, log_pis_old, gaes):
        ...
        if self.learning_steps_ppo % self.epoch_ppo == 0:
            print('loss/actor', loss_actor.item(), self.learning_steps)
            print('stats/entropy', entropy.item(), self.learning_steps)
            '''writer.add_scalar(
