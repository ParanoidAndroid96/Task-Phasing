from fetch_and_slide import FS
...
if(args.load_model != ""):
    ...
    model = CustomPPO2(MlpPolicy, env, verbose=1, seed = 1, n_steps = 1024, tensorboard_log = "log", policy_kwargs=policy_kwargs)
...
print(model)
model.learn(total_timesteps = 20480*100, iteration = 0, **kwargs)
model.save("P&F_4")
