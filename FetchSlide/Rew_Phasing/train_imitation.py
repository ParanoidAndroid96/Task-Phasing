...
def run(args):
    env = FS()#make_env(args.env_id)
    env_test = FS()#make_env(args.env_id)
...
if __name__ == '__main__':
    ...
    p.add_argument('--num_steps', type=int, default=1024*50000)
    p.add_argument('--eval_interval', type=int, default=1024*10)
    p.add_argument('--env_id', type=str, default='FS')
