...
def create_callback(model, verbose=1):
    ...
    def sac_callback(_locals, _globals):
        ...
        file_num = re.findall("\d*", args.load_model[-3:])
...
model.learning_rate = 0.00003#3
model.cliprange = 0.3 #(epislon)
#model.seed = 0
...
model.learn(total_timesteps = 20000*iterations, iteration = 0, **kwargs)
model.save("CTF_4")
